                ...
                <div className="container mx-auto px-4 md:px-6">
                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            {product.category && (
                                <li>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-1 md:ml-2 font-medium text-gray-700 capitalize">
                                            {product.category}
                                        </span>
                                    </div>
                                </li>
                            ...
                            <li aria-current="page">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-1 md:ml-2 font-medium text-gray-400 truncate max-w-[150px] md:max-w-xs">
                                        {product.title}
                                    </span>
                                </div>
                            </li>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        <div className="grid md:grid-cols-2 gap-0">
                            ...
                            <div className="p-8 md:p-12 lg:p-16 flex items-center justify-center bg-white">
                            ...
                            <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-gray-50/50">
                                <div className="mb-2">
                                ...
                                <div className="flex items-center gap-2 mb-6">
                                    <div className="flex text-yellow-400">
                                        {[...Array(5)].map((_, i) => (
                                            <svg
                                                key={i}
                                                className={`w-5 h-5 ${i < Math.round(product.rating?.rate || 0) ? 'fill-current' : 'text-gray-300 fill-current'}`}
                                                viewBox="0 0 20 20"
                                            >
